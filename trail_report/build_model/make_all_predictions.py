...
def get_data(hike, date, df_init, df_trail, weather, weather_dist):
    ...
    Text_X_test_all = hike_all_df[['date_cos',
                                   'date_sin',
                                   'PRCP',
                                   f'neighbors_average {condition}',
                                   'trail_ID']]
...
class TrailPred(object):
    ...
    def prep_train(self, condition):
        ...
        Text_X_train = self.X_train[['date_cos',
                                     'date_sin',
                                     'PRCP',
                                     f'neighbors_average {condition}',
                                     'trail_ID']]
